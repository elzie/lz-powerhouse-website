...
const TheGymContainer = styled.div`
  //   height: 700px;
  width: 100%;
  margin: auto;
  display: flex;
...
const TopImage = styled.div`
  background: url('https://firebasestorage.googleapis.com/v0/b/sm-powerhouseaarhus.appspot.com/o/gfx%2Fthegym_topimage.jpg?alt=media&token=2130618d-83d5-4233-b25e-0cd768907f18');
  width: 950px;
  height: 565px;
`;
const MainText = styled.div``;
const SideBar = styled.div``;
class TheGymBlock1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
